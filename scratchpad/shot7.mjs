...
try {
  ...
  await signup('mike@rivera.com','Mike Rivera');
  await signup('sara@acmehvac.com','Sara Chen');
  // owner sets a profile so identity shows
  ...
  await page.click('a[data-page="settings"]'); await sleep(500);
  await page.click('[data-stab="admin"]'); await sleep(700);
  await page.screenshot({ path:'/home/user/ai-employee/scratchpad/admin.png', fullPage:true });
